...
public class Maze {
	...
	public void findBestPath() {
		...
		while (opened.size() > 0) {
			...
			if (best.isEnd()) {
				...
				//TODO: We want to not just stop on a single goal but on a list of goals (All available resources).
	...
	/**
	 * Running time O(n) -- 
	 * TODO: Improve this to use some sort of self sorting priority queue (can logn be achieved?)
	 * @return
	 */
