...
public class HQSpawnRush extends Behavior {
	...
	public void run() throws GameActionException {
		...
		} else if (utils.soldierCount < ROBOT_SOLDIER_COUNT + utils.generatorCount * 3) { // more gen more soldiers.
			robot.spawn(SoldierSelector.SOLDIER_SWARMER);
		} else if (utils.shouldCreateEncampment(robot.info)) {
	...
	public static final int ROBOT_SOLDIER_COUNT = 10;
